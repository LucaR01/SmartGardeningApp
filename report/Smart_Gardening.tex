...
\textsf{\small Il tirocinio si è svolto dal 23-24 maggio ai primi di ottobre 2022.} %TODO: prima è durato
%\textsf{\small Tutto il codice dell'applicazione si trova su github nella repository, al seguente link: \href{https://github.com/LucaR01/SmartGardeningApp}{Smart Gardening App}.}
...
\textsf{\small Nel modello sono presenti ... piante da giardino comuni.} %TODO: inserire numero piante del modello. 
...
\textsf{\small Se, invece, si vuole modificare il codice occorrerà:} %TODO: Se si vuole modificare il codice, invece, occorrerà:
...
%TODO: magari dire che ho utilizzato una tecnologia nuova che non avevamo visto a lezione.
